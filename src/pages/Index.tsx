...
import { FirebaseAppProvider } from '@/contexts/FirebaseAppContext';
import { formatDistanceToNow } from 'date-fns';
import { it } from 'date-fns/locale';
import { Receipt, Users, CreditCard, CheckCircle, Clock, Filter, Loader2 } from 'lucide-react';
...
const MainApp: React.FC = () => {
  const { currentUser, currentGroup, addExpense, expenses, transactions, payExpense, getSettlements, isLoading } = useApp();
  ...
  const handleCustomExpense = async (e: React.FormEvent) => {
    ...
    if (numAmount > 0) {
      ...
      try {
        await addExpense(numAmount, customDescription || `Spesa €${numAmount}`);
        setCustomAmount('');
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <Loader2 className="w-8 h-8 animate-spin text-banking-blue mx-auto mb-4" />
